...
from server.models.tool_input_schema import (
    CreateSupportTicket,
    GetSupportTicket,
)
from server.models.tool_output_schema import ToolResponse
from server.database.repositories.support_ticket_tool_repositories import (
    create_support_ticket_by_order_id,
...
def register_support_ticket_tools(mcp: FastMCP):
    ...
    async def create_support_ticket(
        ...
        try:
            ...
            logger.warning(
                f"ValueError in create support ticket: {str(e)}"
            )
            ...
            logger.exception(
                f"Unexpected error in create_support_ticket: {e}"
            )
    ...
    async def get_support_ticket(
        ...
        try:
            ...
            logger.warning(
                f"ValueError in get support ticket: {str(e)}"
            )
            ...
            logger.exception(
                f"Unexpected error in get_support_ticket: {e}"
            )
